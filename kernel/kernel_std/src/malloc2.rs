...
use crate::{allocate_page, bitset_size_bytes, deallocate_page, BitSetRaw, Mutable, HEAP_ADDR2};
...
pub fn init_malloc2() {
    ...
    region.bitset_addr = unsafe { (HEAP_ADDR2 as *mut u8).add(2 * 9 * HEAP_REGION_SIZE as usize) };
