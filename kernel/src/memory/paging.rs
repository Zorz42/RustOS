...
fn page_allocator(page: VirtAddr, ignore_if_exists: bool) {
    map_page_auto(page, ignore_if_exists, true, true, false, false);
}
...
pub fn map_page(virtual_addr: VirtAddr, physical_addr: PhysAddr, ignore_if_exists: bool, readable: bool, writable: bool, user: bool, executable: bool) {
...
pub fn map_page_auto(virtual_addr: VirtAddr, ignore_if_exists: bool, readable: bool, writable: bool, user: bool, executable: bool) {
    map_page(virtual_addr, alloc_page(), ignore_if_exists, readable, writable, user, executable);
}
